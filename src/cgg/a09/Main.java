...
public class Main {
        public static void main(String[] args) {
                ...
                // texture
                var earth = new Emission(new ImageTexture("img/earth.jpg"));
                ...
                // var stairLine = muchoMas(spiral2, direction(0, 0, -20), rowStaircase,
                // heightStaircase);
                // var stairGrid = muchoMas(stairLine, direction(-20, 0, 0), rowStairGrid,
                // heightStaircase);
                ...
                var scene = new Group(
                                ...
                                new Background(sky),
                                //new Group (rotation (xAxis, 90), new Plane(point(0, 0, 0), yAxis, 50, sun))
                                new Group(rotation(xAxis, 90), new Plane(point(0, 0, -100), yAxis, 1000, universe))
                                
                                );
                // spiral2,
                // new Plane(point(0,80,0), nyAxis, 100, sky ),
                // new Plane(point(0,-100,0), yAxis, 100, sky ),
                // new Group(rotation(nyAxis, 0),
                // new Sphere(15.0, new Point(0, 14.8, 0), chessBoardTexture)),

                // new Plane(new Point(0, 0, 0), yAxis, 100, grey),
                // new Plane(new Point(0, 100, 0), nyAxis, 100, sun),
                // new Sphere(20, new Point (-30, 10 , 0 ), sun),
                // new Sphere(20, new Point(30, 10, -15), earth));
                // // new Sphere(15.0, new Point(-4, 14.8, -25), earth));
